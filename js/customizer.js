...
( function( $ ) {
	...
	// Sidebar Position.
	wp.customize( 'napoli_theme_options[layout]', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'napoli_theme_options[blog_title]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'napoli_theme_options[blog_description]', function( value ) {
		value.bind( function( to ) {
