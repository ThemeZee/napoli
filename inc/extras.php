 ...
 * @return void
 */
function napoli_retina_logo() {
	// Return early if there is no logo image or option for retina logo is disabled.
	if ( ! has_custom_logo() or false === napoli_get_option( 'retina_logo' ) ) {
		return;
	}
	...
	// Add Custom CSS.
	wp_add_inline_style( 'napoli-stylesheet', $css );
}
add_filter( 'wp_enqueue_scripts', 'napoli_retina_logo', 11 );
